...
public class User {
	...
	// Lista di task che un user deve svolgere
	@OneToMany
	...
	//Se l'user ha visibilità sul progetto allo posso aggiungergli un task
	public void addTask(Task task) {
		boolean flag = false;
		for (Project p : this.getVisibleProjects()) {
		...
		if(flag == false) {
			System.out.println("L'utente non ha visibilità");
		}
	}
}
